              ...
              child: ListView(
                children: <Widget>[
                  Container(
                    ...
                    child: Text("Set Quantity of Shares",
                        style: TextStyle(
                          fontFamily: "Medium",
                          fontSize: 26,
                        )),
                  ...
                  Container(
                    alignment: Alignment(-1, 0),
                    padding: const EdgeInsets.fromLTRB(0, 20, 0, 20),
                    child: Text("Select the amount of shares you want to purchase",
                        style: TextStyle(
                          fontFamily: "Regular",
                          fontSize: 19,
                          color: Colors.grey,
                  ...
                  Row(
                      ...
                      children: <Widget>[
                          ...
                          Expanded(
                            ...
                            child: Text("Market Value As of 02/09/2020 10:24 AM",
                                style: TextStyle(
                                  fontFamily: "Regular",
                                  fontSize: 10,
                                )),
                  ...
                  Container(
                      ...
                      child: FlatButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => MySummary(ticker: this.stock_name, marketVal: this.price, quantity: this.quantity )),
                            );
                          },
                          child: Text("Next",
